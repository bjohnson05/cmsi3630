...
class HuffmanTreeApp {
   public static void main( String[] args ) throws IOException {
      int value;
      // String initString = "SUSIE SAYS IT IS EASY";
      System.out.print( "\n\n   Enter some text to encode/decode: " );
      String initString = getString();
      String encoded = new String();
      String decoded = new String();
      HuffmanTree theTree = new HuffmanTree( initString );

      while(true) {
         System.out.print("Enter first letter of decode, encode, show, traverse,"
               + " or quit: ");
         int choice = getChar();
         switch( choice ) {
         case 'e':
