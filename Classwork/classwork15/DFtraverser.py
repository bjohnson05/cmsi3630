...
dpth.graph.insertVertex( 'A' )
dpth.graph.insertVertex( 'B' )
dpth.graph.insertVertex( 'C' )
dpth.graph.insertVertex( 'D' )
dpth.graph.insertVertex( 'E' )
dpth.graph.insertVertex( 'F' )
dpth.graph.insertVertex( 'G' )
dpth.graph.insertVertex( 'H' )
dpth.graph.insertVertex( 'I' )
dpth.graph.printGraph()
...
dpth.graph.insertVertex( 'H' )
dpth.graph.insertVertex( 'I' )
dpth.graph.insertVertex( 'J' )
dpth.graph.insertVertex( 'K' )
dpth.graph.insertVertex( 'L' )
dpth.graph.printGraph()
...
dpth.graph.connect( 'A', 'C' )
dpth.graph.connect( 'A', 'D' )
dpth.graph.connect( 'C', 'F' )
dpth.graph.connect( 'C', 'G' )
dpth.graph.connect( 'D', 'E' )
dpth.graph.connect( 'D', 'H' )
dpth.graph.connect( 'F', 'I' )
dpth.graph.connect( 'G', 'J' )
dpth.graph.connect( 'J', 'H' )
dpth.graph.connect( 'J', 'L' )
dpth.graph.connect( 'H', 'E' )
dpth.graph.connect( 'H', 'K' )
dpth.graph.printGraph()

print( "\n   Calling DFT routine, starting at vertex 'C'..." )
dpth.dft( dpth.graph, 'C' )
print( "   Result of DFT, order is:\n     ", dpth.printOrder )
